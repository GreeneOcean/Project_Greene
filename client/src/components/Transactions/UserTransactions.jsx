...
const UserTransactions = ({ user }) => {
  ...
  return (
    <TransactionContainer>
      <div>
        <PlaceholderButton onClick={() => setGroup("both")}>
          Both
        </PlaceholderButton>
        <PlaceholderButton onClick={() => setGroup("received")}>
          Received
        </PlaceholderButton>
        <PlaceholderButton onClick={() => setGroup("donations")}>
          Donations
        </PlaceholderButton>
      </div>
      <div>
        <PlaceholderButton onClick={() => setStatus("approved")}>
          Pending
        </PlaceholderButton>
        <PlaceholderButton onClick={() => setStatus("claimed")}>
          Claimed
        </PlaceholderButton>
        <PlaceholderButton onClick={() => setStatus("unclaimed")}>
          Unclaimed
        </PlaceholderButton>
        <PlaceholderButton onClick={() => setStatus("donated")}>
          History
        </PlaceholderButton>
      </div>
      <div>
